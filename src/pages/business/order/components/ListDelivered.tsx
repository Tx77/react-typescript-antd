...
function ListDelivered(props: Props) {
  const { history } = props;

  const { loading, list, paginationConfig } = usePagination<Order.OrderItem>(API.fetchOrderPage, { status: 30 });
...
export default withRouter(ListDelivered);
