...
// 请求地址
axios.defaults.baseURL = 'https://yjhw-pub.servicesplus.cn/api/seller';
...
axios.interceptors.response.use(
  (response): any => {
    ...
    // 非成功状态提示
    if (!result.apiStatus || !result.sysStatus || Number(result.apiStatus) !== 0 || Number(result.sysStatus) !== 0) {
